...
private:
  ...
  GH1*  Zp_Vert_DetSum8;
  GH1*  Zn_Vert_DetSum8;
  GH1*  Zp_Vert_DetSum12;
  GH1*  Zn_Vert_DetSum12;
  GH1*  Ekp;
  GH1*  Ekn;
  GH1*  Ekp_DetSum8;
  GH1*  Ekn_DetSum8;
  ...
  GH1*  ThetaProt;
  GH1*  ThetaNeut;
  GH1*  ThetaProt_DetSum8;
  GH1*  ThetaNeut_DetSum8;
  GH1*  ThetaProt_DetSum12;
  GH1*  ThetaNeut_DetSum12;
  GH1*  PhiProt;
  GH1*  PhiNeut;
  GH1*  PhiProt_DetSum8;
  GH1*  PhiNeut_DetSum8;
  GH1*  PhiProt_DetSum12;
  GH1*  PhiNeut_DetSum12;
  GH1*  MM_Proton;
  GH1*  MM_Proton_DetSum8;
  GH1*  MM_Proton_DetSum12;
