...
public:
    ...
    TRotation ScatterFrame(TVector3 InitialVect, TVector3 RealPVect, TVector3 ScattVector, TLorentzVector GammaVect);

    TVector3 ScatteredFrameAnglesMB(TVector3 InitialVect, TVector3 RealPVect, TVector3 ScattVector, TLorentzVector GammaVect);
    TVector3 ScatteredFrameAnglesMB2(TLorentzVector InitialVect, TLorentzVector RealPVect, TLorentzVector ScattVector, TLorentzVector GammaVect);
