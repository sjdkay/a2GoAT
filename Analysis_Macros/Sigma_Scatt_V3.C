...
void Sigma_Scatt_V3(){
    ...
    TFile *f1 = new TFile("/scratch/Mainz_Software/Data/GoAT_Output/GoAT_23_01_17/Perp/Physics_Total_Perp_37_18_5_18.root"); // Open latest Para file
    ...
    TFile f2("ParaPerp_S37_Combined.root", "RECREATE");
    ...
    TFile f3("ParaPerpAsymm_S37.root", "RECREATE");
    ...
    TFile f5("Sigma_Plots_S37.root", "RECREATE");
