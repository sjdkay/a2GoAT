...
void Sigma_Scatt_V3(){
    ...
    TFile *f = new TFile("/scratch/Mainz_Software/Data/GoAT_Output/GoAT_23_01_17/Para/Physics_Total_Para_47_28_5_18_V2.root"); // Open latest Para file
    ...
    TFile *f1 = new TFile("/scratch/Mainz_Software/Data/GoAT_Output/GoAT_23_01_17/Perp/Physics_Total_Perp_47_28_5_18_V2.root"); // Open latest Para file
    ...
    TFile f2("ParaPerp_S47_Combined_V2.root", "RECREATE");
    ...
    TFile f3("ParaPerpAsymm_S47_V2.root", "RECREATE");
    ...
    TFile f5("Sigma_Plots_S47_V2.root", "RECREATE");
