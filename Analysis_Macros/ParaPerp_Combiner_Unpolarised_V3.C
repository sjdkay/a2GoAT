...
void ParaPerp_Combiner_Unpolarised_V3() {
    ...
    TFile *f = new TFile("/d4tb1/sjdkay/MainzRecoil/GoAT_Output_Files/nobackup/GoAT_Files/Para/Physics_Total_Para_53_13_03_19.root"); // Open latest Para file
    ...
    TFile *f1 = new TFile("/d4tb1/sjdkay/MainzRecoil/GoAT_Output_Files/nobackup/GoAT_Files/Perp/Physics_Total_Perp_53_13_03_19.root"); // Open latest Perp file
    ...
    TFile f2("ParaPerp_Total_53_Combined_Unpolarised_50MeV_Cent_V2.root", "RECREATE");
