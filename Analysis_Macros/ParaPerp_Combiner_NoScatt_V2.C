...
void ParaPerp_Combiner_NoScatt_V2(){
    ...
    TFile *f = new TFile("/scratch/Mainz_Software/Data/GoAT_Output/GoAT_23_01_17/Para/NoScatt/Physics_Total_Para_NoScatt_20_01_5_18.root"); // Open latest Para file
    ...
    TFile *f1 = new TFile("/scratch/Mainz_Software/Data/GoAT_Output/GoAT_23_01_17/Perp/NoScatt/Physics_Total_Perp_NoScatt_20_01_5_18.root"); // Open latest Para file
    ...
    TFile f2("ParaPerp_NS20_Combined.root", "RECREATE");
