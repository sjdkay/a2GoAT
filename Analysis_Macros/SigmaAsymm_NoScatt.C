...
void SigmaAsymm_NoScatt(){
  ...
  TFile *f = new TFile("/scratch/Mainz_Software/Data/GoAT_Output/GoAT_23_01_17/ParaPerp_NoScatt_Total_6_Combined.root"); // Open the latest PTotal combined file to load histograms from
  ...
  TFile f1("ParaPerpAsymm_NoScatt_Total_6.root", "RECREATE");
