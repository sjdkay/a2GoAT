...
void CosFitMCOut(){
  ...
  for(Int_t i = 0; i < 10; i++){
    ...
    if(i==7){
        ...
        Char_t* Title2 = "Ratio of Angle bin to maximum for 475 +/- 25 MeV; Ratio475MeV";
  ...
  leg->Draw("Same");
  canvas->SaveAs("./PolEGamma_MCOut.pdf");
  canvas->SaveAs("./PolEGamma_MCOut.png");
  ...
  warn->Draw("SAME");
  canvas->SaveAs("./Y_OffsetEGamma_MCOut.pdf");
  canvas->SaveAs("./Y_OffsetEGamma_MCOut.png");
