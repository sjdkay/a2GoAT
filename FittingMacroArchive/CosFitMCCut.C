...
void CosFitMCCut(){
  ...
  for(Int_t i = 0; i < 10; i++){
    ...
    if(i==0){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_125MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_125MeV.png";
        RebinVal = 1;
        Float_t yMax = 150;
      }
    ...
    if(i==1){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_175MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_175MeV.png";
        RebinVal = 1;
        Float_t yMax = 250;
      }
    ...
    if(i==2){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_225MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_225MeV.png";
        RebinVal = 1;
        Float_t yMax = 150;
      }
    ...
    if(i==3){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_275MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_275MeV.png";
        RebinVal = 1;
        Float_t yMax = 80;
      }
    ...
    if(i==4){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_325MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_325MeV.png";
        RebinVal = 1;
        Float_t yMax = 50;
      }
    ...
    if(i==5){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_375MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_375MeV.png";
        RebinVal = 2;
        Float_t yMax = 50;
      }
    ...
    if(i==6){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_425MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_425MeV.png";
        RebinVal = 2;
        Float_t yMax = 75;
      }
    ...
    if(i==7){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_475MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_475MeV.png";
        RebinVal = 2;
        Float_t yMax = 30;
      }
    ...
    if(i==8){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_525MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_525MeV.png";
        RebinVal = 2;
        Float_t yMax = 30;
      }
    ...
    if(i==9){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_575MeV.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_575MeV.png";
        RebinVal = 2;
        Float_t yMax = 30;
      }
  ...
  leg->Draw("Same");
  warn->Draw("SAME");
  canvas->SaveAs("./PolEGamma_MCCut.pdf");
  canvas->SaveAs("./PolEGamma_MCCut.png");
  ...
  warn->Draw("SAME");
  canvas->SaveAs("./Y_OffsetEGamma_MCCut.pdf");
  canvas->SaveAs("./Y_OffsetEGamma_MCCut.png");
