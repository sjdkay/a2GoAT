...
void CosFitMCInCut(){
  ...
  for(Int_t i = 0; i < 10; i++){
    ...
    if(i==0){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_125MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_125MeV_In.png";
        RebinVal = 1;
        Float_t yMax = 150;
      }
    ...
    if(i==1){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_175MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_175MeV_In.png";
        RebinVal = 1;
        Float_t yMax = 250;
      }
    ...
    if(i==2){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_225MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_225MeV_In.png";
        RebinVal = 1;
        Float_t yMax = 150;
      }
    ...
    if(i==3){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_275MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_275MeV_In.png";
        RebinVal = 1;
        Float_t yMax = 80;
      }
    ...
    if(i==4){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_325MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_325MeV_In.png";
        RebinVal = 1;
        Float_t yMax = 50;
      }
    ...
    if(i==5){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_375MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_375MeV_In.png";
        RebinVal = 2;
        Float_t yMax = 50;
      }
    ...
    if(i==6){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_425MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_425MeV_In.png";
        RebinVal = 2;
        Float_t yMax = 50;
      }
    ...
    if(i==7){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_475MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_475MeV_In.png";
        RebinVal = 2;
        Float_t yMax = 30;
      }
    ...
    if(i==8){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_525MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_525MeV_In.png";
        RebinVal = 2;
        Float_t yMax = 30;
      }
    ...
    if(i==9){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_575MeV_In.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_575MeV_In.png";
        RebinVal = 2;
        Float_t yMax = 30;
      }
  ...
  leg->Draw("Same");
  warn->Draw("SAME");
  canvas->SaveAs("./PolEGamma_MCInCut.pdf");
  canvas->SaveAs("./PolEGamma_MCInCut.png");
  ...
  warn->Draw("SAME");
  canvas->SaveAs("./Y_OffsetEGamma_MCInCut.pdf");
  canvas->SaveAs("./Y_OffsetEGamma_MCInCut.png");

 TFile *f1= TFile::Open("MCInParametersCut.root");
