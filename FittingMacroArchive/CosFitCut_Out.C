...
void CosFitCut_Out(){
  ...
  TFile *f1= TFile::Open("MCOutParametersCut.root");
  ...
  for(Int_t i = 0; i < 10; i++){
    ...
    if(i==0){
        ...
        Char_t* GraphPDF = "./CosFit_125MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_125MeV_Cut_Out.png";
        RebinVal = 1;
        Float_t yMax = 250;
      }
    ...
    if(i==1){
        ...
        Char_t* GraphPDF = "./CosFit_175MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_175MeV_Cut_Out.png";
        RebinVal = 1;
        Float_t yMax = 200;
      }
    ...
    if(i==2){
        ...
        Char_t* GraphPDF = "./CosFit_225MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_225MeV_Cut_Out.png";
        RebinVal = 1;
        Float_t yMax = 200;
      }
    ...
    if(i==3){
        ...
        Char_t* GraphPDF = "./CosFit_275MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_275MeV_Cut_Out.png";
        RebinVal = 1;
        Float_t yMax = 60;
      }
    ...
    if(i==4){
        ...
        Char_t* GraphPDF = "./CosFit_325MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_325MeV_Cut_Out.png";
        RebinVal = 2;
        Float_t yMax = 80;
      }
    ...
    if(i==5){
        ...
        Char_t* GraphPDF = "./CosFit_375MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_375MeV_Cut_Out.png";
        RebinVal = 2;
        Float_t yMax = 40;
      }
    ...
    if(i==6){
        ...
        Char_t* GraphPDF = "./CosFit_425MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_425MeV_Cut_Out.png";
        RebinVal = 4;
        Float_t yMax = 60;
      }
    ...
    if(i==7){
        ...
        Char_t* GraphPDF = "./CosFit_475MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_475MeV_Cut_Out.png";
        RebinVal = 4;
        Float_t yMax = 60;
      }
    ...
    if(i==8){
        ...
        Char_t* GraphPDF = "./CosFit_525MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_525MeV_Cut_Out.png";
        RebinVal = 4;
        Float_t yMax = 110;
      }
    ...
    if(i==9){
        ...
        Char_t* GraphPDF = "./CosFit_575MeV_Cut_Out.pdf";
        Char_t* GraphPNG = "./CosFit_575MeV_Cut_Out.png";
        RebinVal = 4;
        Float_t yMax = 100;
      }
  ...
  leg->Draw("Same");
  canvas->SaveAs("./PolEGammaCut_Out.pdf");
  canvas->SaveAs("./PolEGammaCut_Out.png");
  ...
  warn->Draw("SAME");
  canvas->SaveAs("./Y_OffsetEGammaCut_Out.pdf");
  canvas->SaveAs("./Y_OffsetEGammaCut_Out.png");
