...
void CosFitCut_In(){
  ...
  for(Int_t i = 0; i < 10; i++){
    ...
    if(i==0){
        ...
        Char_t* GraphPDF = "./CosFit_125MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_125MeV_Cut_In.png";
        RebinVal = 1;
        Float_t yMax = 300;
      }
    ...
    if(i==1){
        ...
        Char_t* GraphPDF = "./CosFit_175MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_175MeV_Cut_In.png";
        RebinVal = 1;
        Float_t yMax = 750;
      }
    ...
    if(i==2){
        ...
        Char_t* GraphPDF = "./CosFit_225MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_225MeV_Cut_In.png";
        RebinVal = 1;
        Float_t yMax = 600;
      }
    ...
    if(i==3){
        ...
        Char_t* GraphPDF = "./CosFit_275MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_275MeV_Cut_In.png";
        RebinVal = 1;
        Float_t yMax = 450;
      }
    ...
    if(i==4){
        ...
        Char_t* GraphPDF = "./CosFit_325MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_325MeV_Cut_In.png";
        RebinVal = 1;
        Float_t yMax = 400;
      }
    ...
    if(i==5){
        ...
        Char_t* GraphPDF = "./CosFit_375MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_375MeV_Cut_In.png";
        RebinVal = 1;
        Float_t yMax = 120;
      }
    ...
    if(i==6){
        ...
        Char_t* GraphPDF = "./CosFit_425MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_425MeV_Cut_In.png";
        RebinVal = 1;
        Float_t yMax = 150;
      }
    ...
    if(i==7){
        ...
        Char_t* GraphPDF = "./CosFit_475MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_475MeV_Cut_In.png";
        RebinVal = 2;
        Float_t yMax = 50;
      }
    ...
    if(i==8){
        ...
        Char_t* GraphPDF = "./CosFit_525MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_525MeV_Cut_In.png";
        RebinVal = 2;
        Float_t yMax = 80;
      }
    ...
    if(i==9){
        ...
        Char_t* GraphPDF = "./CosFit_575MeV_Cut_In.pdf";
        Char_t* GraphPNG = "./CosFit_575MeV_Cut_In.png";
        RebinVal = 2;
        Float_t yMax = 40;
      }
  ...
  leg->Draw("Same");
  canvas->SaveAs("./PolEGammaCut_In.pdf");
  canvas->SaveAs("./PolEGammaCut_In.png");
  ...
  warn->Draw("SAME");
  canvas->SaveAs("./Y_OffsetEGammaCut_In.pdf");
  canvas->SaveAs("./Y_OffsetEGammaCut_In.png");
