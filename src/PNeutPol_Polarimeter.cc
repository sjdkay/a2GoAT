...
PNeutPol_Polarimeter::PNeutPol_Polarimeter() // Define a load of histograms to fill
{
  ...
  E_dE_p = new GH2("E_dE_p", "EdE Plot for Protons", 150, 0, 500, 150, 0, 7);
  E_dE_n = new GH2("E_dE_n", "EdE Plot for Neutrons", 150, 0, 500, 150, 0, 7);
  E_dE_DetSum8 = new GH2("E_dE_DetSum8", "EdE Plot DetSum8", 150, 0, 500, 150, 0, 7);
  E_dE_p_DetSum8 = new GH2("E_dE_p_DetSum8", "EdE Plot for Protons DetSum8", 150, 0, 500, 150, 0, 7);
  E_dE_n_DetSum8 = new GH2("E_dE_n_DetSum8", "EdE Plot for Neutrons DetSum8", 150, 0, 500, 150, 0, 7);
  E_dE_DetSum12 = new GH2("E_dE_DetSum12", "EdE Plot DetSum12", 150, 0, 500, 150, 0, 7);
