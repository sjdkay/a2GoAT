...
TCutG*	P1pi0::OpenCutFile(Char_t* filename, Char_t* cutname)
{
...
Double_t P1pi0::MCSmearing() // Smear dE values for MC data to represent Energy resolution of PID
{
...
Double_t P1pi0::PNProp(Int_t ProtonParticleNumber) // Define properties of proton and neutron from particles that correspond to each
{
...
TLorentzVector P1pi0::PNVect(Int_t ProtonParticleNumber) // Define vectors for p and n in similar manner to properties above
{
  if(ProtonParticleNumber == 1)
    {
      GVp = GV1;
...
Double_t P1pi0::NeutronEnergy() // Calculate the neutron energy from the reconstructed n vector and from kinematics
...
Double_t P1pi0::LabBoost() // Boost particles from lab frame to CM
{
...
Double_t P1pi0::WCVertex() // Calculate location of WC Z vertex for measured and reconstructed vector
{
...
TVector3 P1pi0::DefineAxes(TVector3 ProtonVector, TVector3 ReconstuctedNeutronVector)
{
