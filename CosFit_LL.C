...
void CosFit_LL(){
  ...
  for(Int_t i = 0; i < 10; i++){
    ...
    if(i==0){
        ...
        Char_t* GraphPDF = "./CosFit_125MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_125MeV_LL.png";
        RebinVal = 2;
        Float_t yMax = 200;
      }
    ...
    if(i==1){
        ...
        Char_t* GraphPDF = "./CosFit_175MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_175MeV_LL.png";
        RebinVal = 2;
        Float_t yMax = 250;
      }
    ...
    if(i==2){
        ...
        Char_t* GraphPDF = "./CosFit_225MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_225MeV_LL.png";
        RebinVal = 5;
        Float_t yMax = 550;
      }
    ...
    if(i==3){
        ...
        Char_t* GraphPDF = "./CosFit_275MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_275MeV_LL.png";
        RebinVal = 2;
        Float_t yMax = 250;
      }
    ...
    if(i==4){
        ...
        Char_t* GraphPDF = "./CosFit_325MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_325MeV_LL.png";
        RebinVal = 5;
        Float_t yMax = 250;
      }
    ...
    if(i==5){
        ...
        Char_t* GraphPDF = "./CosFit_375MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_375MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 250;
      }
    ...
    if(i==6){
        ...
        Char_t* GraphPDF = "./CosFit_425MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_425MeV_LL.png";
        RebinVal = 20;
        Float_t yMax = 200;
      }
    ...
    if(i==7){
        ...
        Char_t* GraphPDF = "./CosFit_475MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_475MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 80;
      }
    ...
    if(i==8){
        ...
        Char_t* GraphPDF = "./CosFit_525MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_525MeV_LL.png";
        RebinVal = 20;
        Float_t yMax = 60;
      }
    ...
    if(i==9){
        ...
        Char_t* GraphPDF = "./CosFit_575MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_575MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 30;
      }
  ...
  leg->Draw("Same");
  canvas->SaveAs("./PolEGamma_LL.pdf");
  canvas->SaveAs("./PolEGamma_LL.png");
  ...
  warn->Draw("SAME");
  canvas->SaveAs("./Y_OffsetEGamma_LL.pdf");
  canvas->SaveAs("./Y_OffsetEGamma_LL.png");
