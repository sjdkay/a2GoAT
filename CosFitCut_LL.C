...
void CosFitCut_LL(){
  ...
  for(Int_t i = 0; i < 10; i++){
    ...
    if(i==0){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_125MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_125MeV_LL.png";
        RebinVal = 5;
        Float_t yMax = 250;
      }
    ...
    if(i==1){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_175MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_175MeV_LL.png";
        RebinVal = 2;
        Float_t yMax = 200;
      }
    ...
    if(i==2){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_225MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_225MeV_LL.png";
        RebinVal = 5;
        Float_t yMax = 500;
      }
    ...
    if(i==3){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_275MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_275MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 500;
      }
    ...
    if(i==4){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_325MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_325MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 500;
      }
    ...
    if(i==5){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_375MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_375MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 150;
      }
    ...
    if(i==6){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_425MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_425MeV_LL.png";
        RebinVal = 20;
        Float_t yMax = 150;
      }
    ...
    if(i==7){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_475MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_475MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 50;
      }
    ...
    if(i==8){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_525MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_525MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 40;
      }
    ...
    if(i==9){
        ...
        Char_t* GraphPDF = "./CosFit_Cut_575MeV_LL.pdf";
        Char_t* GraphPNG = "./CosFit_Cut_575MeV_LL.png";
        RebinVal = 10;
        Float_t yMax = 40;
      }
  ...
  leg->Draw("Same");
  warn->Draw("SAME");
  canvas->SaveAs("./PolEGammaCut_LL.pdf");
  canvas->SaveAs("./PolEGammaCut_LL.png");
  ...
  warn->Draw("SAME");
  canvas->SaveAs("./Y_OffsetEGammaCut_LL.pdf");
  canvas->SaveAs("./Y_OffsetEGammaCut_LL.png");
